...
#
# Generated by Vivado on Mon Nov 20 17:24:51 +0800 2017
...
# Script info
echo -e "FIFO.sh - Script generated by export_simulation (Vivado v2016.4 (64-bit)-id)\n"
...
elaborate()
{
  $xv_path/bin/xelab --relax --debug typical --mt auto -L fifo_generator_v13_1_3 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot FIFO xil_defaultlib.FIFO xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  $xv_path/bin/xsim FIFO -key {Behavioral:sim_1:Functional:FIFO} -tclbatch cmd.tcl -log simulate.log
}
